  ...
  return (
    <main className="min-h-screen font-sans">
      ...
      <header className="bg-white shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex flex-wrap items-center justify-between gap-3">
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <div className="hidden sm:block text-xs text-gray-500">ENGINEERING ENTERPRISES</div>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            <Link href="/admin/login"><a className="hidden sm:inline text-sm text-gray-700">Admin Sign In</a></Link>
            <Link href="/client"><a className="px-3 sm:px-4 py-2 bg-yellow-400 text-black rounded text-sm sm:text-base whitespace-nowrap">Book a Service</a></Link>
          </div>
        </div>
      </header>
      ...
      <section className="bg-gradient-to-r from-white via-white to-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-12 grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          <div className="lg:col-span-7">
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-black leading-tight">POWERING SOLUTIONS, BUILDING <span className="text-yellow-400">TRUST.</span></h1>
            ...
            <div className="bg-white shadow-lg rounded p-6">
              ...
              <form onSubmit={submitRequest} className="mt-4 space-y-3">
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                  <button type="submit" disabled={sending} className="px-4 py-2 bg-yellow-400 text-black rounded w-full sm:w-auto">{sending ? 'Sending...' : 'Submit Request'}</button>
      ...
      <section className="bg-black text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 items-center justify-items-center sm:justify-items-start">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
              {products.length === 0 && (
                <div className="col-span-full text-sm text-gray-500 border border-dashed rounded-lg p-6 text-center">
